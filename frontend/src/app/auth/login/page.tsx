      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-2xl rounded-[2rem] border border-white/10 p-8 shadow-2xl">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 py-3.5 rounded-xl text-sm font-semibold text-white transition-all active:scale-[0.98]"
          >
